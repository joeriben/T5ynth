...
public:
    ...
    */
    ...
    void showAudioSettingsDialog()
    {
        ...
        o.dialogTitle                   = TRANS ("MIDI/Audio Settings");
    ...
    /** Optional extra component shown below the audio device selector in the settings dialog. */
    Component* extraSettingsPanel = nullptr;
    ...
    */
    ...
    public:
              ...
              shouldMuteButton ("Mute audio input")
        {
            ...
            if (owner.extraSettingsPanel != nullptr)
                addAndMakeVisible (owner.extraSettingsPanel);
        }
        ...
        void resized() override
        {
            ...
            if (owner.extraSettingsPanel != nullptr)
            {
                auto extraArea = r.removeFromBottom (owner.extraSettingsPanel->getHeight());
                owner.extraSettingsPanel->setBounds (extraArea);
            }
        ...
        void setToRecommendedSize()
        {
            ...
            int panelH = (owner.extraSettingsPanel != nullptr) ? owner.extraSettingsPanel->getHeight() : 0;
            setSize (getWidth(), deviceSelector.getHeight() + extraHeight + panelH);
        }
